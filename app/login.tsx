...
export default function LoginScreen() {
  ...
  const handleLogin = () => {
    if (validate()) {
      ...
      setTimeout(() => {
        setIsLoading(false);
        // Navigate to app home screen after login
          ...
          <View style={styles.container}>
            ...
            <View style={styles.formContainer}>
              ...
              <View style={styles.inputContainer}>
                ...
                {/* Password input with focus state styling */}
                <View style={[
                  styles.passwordWrapper,
                  errors.password ? { borderColor: '#ef4444' } : null,
                  isPasswordFocused ? { borderColor: '#000000', borderWidth: 2 } : null
                ]}>
...
const styles = StyleSheet.create({
  ...
  passwordContainer: {
    ...
    height: 50,
    overflow: 'hidden',
    // Add these properties to ensure proper clipping
    clipToBounds: true,
  },
  passwordInput: {
    flex: 1,
